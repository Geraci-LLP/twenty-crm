...
export interface MutationGenqlSelection {
  ...
  sendCampaign?: CampaignActionOutputGenqlSelection & {
    __args: { input: SendCampaignInput };
  };
  scheduleCampaign?: CampaignActionOutputGenqlSelection & {
    __args: { input: ScheduleCampaignInput };
  };
  pauseCampaign?: CampaignActionOutputGenqlSelection & {
    __args: { input: PauseCampaignInput };
  };
  resumeCampaign?: CampaignActionOutputGenqlSelection & {
    __args: { input: ResumeCampaignInput };
  };
  sendTestEmail?: CampaignActionOutputGenqlSelection & {
    __args: { input: SendTestEmailInput };
  };
  resolveRecipients?: ResolveRecipientsOutputGenqlSelection & {
    __args: { input: ResolveRecipientsInput };
  };
  saveAsTemplate?: CampaignActionOutputGenqlSelection & {
    __args: { input: SaveAsTemplateInput };
  };
  loadTemplate?: CampaignActionOutputGenqlSelection & {
    __args: { input: LoadTemplateInput };
  };
  createDripCampaign?: CreateDripCampaignOutputDTOGenqlSelection & {
    __args: { input: CreateDripCampaignInput };
  };
  activateDripCampaign?: DripCampaignActionOutputDTOGenqlSelection & {
    __args: { input: ActivateDripCampaignInput };
  };
  pauseDripCampaign?: DripCampaignActionOutputDTOGenqlSelection & {
    __args: { input: PauseDripCampaignInput };
  };
  enrollContacts?: EnrollContactsOutputDTOGenqlSelection & {
    __args: { input: EnrollContactsInput };
  };
  unenrollContact?: DripCampaignActionOutputDTOGenqlSelection & {
    __args: { input: UnenrollContactInput };
  };
...
export interface ResolveRecipientsInput {
  ...
  viewId?: Scalars['String'] | null;
  personIds?: Scalars['String'][] | null;
}
...
export interface ActivateDripCampaignInput {
  dripCampaignId: Scalars['ID'];
}

export interface PauseDripCampaignInput {
  dripCampaignId: Scalars['ID'];
}

export interface EnrollContactsInput {
  dripCampaignId: Scalars['ID'];
  personIds: Scalars['ID'][];
}

export interface UnenrollContactInput {
...
export const isCampaignActionOutput = (
  obj?: { __typename?: any } | null,
): obj is CampaignActionOutput => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCampaignActionOutput"');
  return CampaignActionOutput_possibleTypes.includes(obj.__typename);
};

const ResolveRecipientsOutput_possibleTypes: string[] = [
  'ResolveRecipientsOutput',
];
export const isResolveRecipientsOutput = (
  obj?: { __typename?: any } | null,
): obj is ResolveRecipientsOutput => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isResolveRecipientsOutput"');
  return ResolveRecipientsOutput_possibleTypes.includes(obj.__typename);
};

const DripCampaignActionOutputDTO_possibleTypes: string[] = [
  'DripCampaignActionOutputDTO',
];
export const isDripCampaignActionOutputDTO = (
  obj?: { __typename?: any } | null,
): obj is DripCampaignActionOutputDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isDripCampaignActionOutputDTO"');
  return DripCampaignActionOutputDTO_possibleTypes.includes(obj.__typename);
};

const CreateDripCampaignOutputDTO_possibleTypes: string[] = [
  'CreateDripCampaignOutputDTO',
];
export const isCreateDripCampaignOutputDTO = (
  obj?: { __typename?: any } | null,
): obj is CreateDripCampaignOutputDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCreateDripCampaignOutputDTO"');
  return CreateDripCampaignOutputDTO_possibleTypes.includes(obj.__typename);
};

const EnrollContactsOutputDTO_possibleTypes: string[] = [
  'EnrollContactsOutputDTO',
];
export const isEnrollContactsOutputDTO = (
  obj?: { __typename?: any } | null,
): obj is EnrollContactsOutputDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEnrollContactsOutputDTO"');
