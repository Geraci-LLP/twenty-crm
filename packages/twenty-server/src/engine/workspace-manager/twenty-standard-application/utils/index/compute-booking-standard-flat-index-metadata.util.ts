...
export const buildBookingStandardFlatIndexMetadatas = ({
  now,
  objectName,
  workspaceId,
...
}: Omit<CreateStandardIndexArgs<'booking'>, 'context'>): Record<
  AllStandardObjectIndexName<'booking'>,
  FlatIndexMetadata
> => ({
