...
export const buildChatConversationStandardFlatIndexMetadatas = ({
  now,
  objectName,
  workspaceId,
...
}: Omit<CreateStandardIndexArgs<'chatConversation'>, 'context'>): Record<
  AllStandardObjectIndexName<'chatConversation'>,
  FlatIndexMetadata
> => ({
