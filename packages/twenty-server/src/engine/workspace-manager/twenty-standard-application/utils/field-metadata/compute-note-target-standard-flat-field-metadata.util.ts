...
>): Record<AllStandardObjectFieldName<'noteTarget'>, FlatFieldMetadata> => ({
  ...
  targetTrackedDocument: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetTrackedDocument',
      label: i18nLabel(msg`Target`),
      description: i18nLabel(msg`NoteTarget target`),
      icon: 'IconArrowUpRight',
      isNullable: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetTrackedDocumentId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetMeetingType: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetMeetingType',
      label: i18nLabel(msg`Target`),
      description: i18nLabel(msg`NoteTarget target`),
      icon: 'IconArrowUpRight',
      isNullable: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetMeetingTypeId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetChatWidget: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetChatWidget',
      label: i18nLabel(msg`Target`),
      description: i18nLabel(msg`NoteTarget target`),
      icon: 'IconArrowUpRight',
      isNullable: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetChatWidgetId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetSequence: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetSequence',
      label: i18nLabel(msg`Target`),
      description: i18nLabel(msg`NoteTarget target`),
      icon: 'IconArrowUpRight',
      isNullable: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetSequenceId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
