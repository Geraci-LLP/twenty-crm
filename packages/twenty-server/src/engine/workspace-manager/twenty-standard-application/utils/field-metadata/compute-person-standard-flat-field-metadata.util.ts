...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  documentSharingLinks: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'documentSharingLinks',
      label: i18nLabel(msg`Document Sharing Links`),
      description: i18nLabel(
        msg`Document sharing links associated with the person`,
      ),
      icon: 'IconLink',
      isNullable: true,
  ...
  documentViews: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Document views by the person`),
      icon: 'IconEye',
      isNullable: true,
  ...
  bookings: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Meeting bookings associated with the person`),
  ...
  chatConversations: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'chatConversations',
      label: i18nLabel(msg`Chat Conversations`),
      description: i18nLabel(
        msg`Chat conversations associated with the person`,
      ),
      icon: 'IconMessages',
      isNullable: true,
  ...
  sequenceEnrollments: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      ...
      label: i18nLabel(msg`Sequence Enrollments`),
      description: i18nLabel(msg`Sales sequence enrollments for the person`),
      icon: 'IconRoute',
      isNullable: true,
