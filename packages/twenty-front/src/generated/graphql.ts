...
export type GetTimelineCalendarEventsFromOpportunityIdQuery = {
  __typename?: 'Query';
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'GetTimelineCalendarEventsFromCompanyId' },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            name: {
              kind: 'Name',
              value: 'getTimelineCalendarEventsFromCompanyId',
            },
            arguments: [
              {
                kind: 'Argument',
...
>;
export const GetTimelineCalendarEventsFromOpportunityIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      name: {
        kind: 'Name',
        value: 'GetTimelineCalendarEventsFromOpportunityId',
      },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
  ...
  GetTimelineCalendarEventsFromOpportunityIdQuery,
  GetTimelineCalendarEventsFromOpportunityIdQueryVariables
>;
export const GetTimelineCalendarEventsFromPersonIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetTimelineCalendarEventsFromPersonId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            name: {
              kind: 'Name',
              value: 'getTimelineCalendarEventsFromPersonId',
            },
            arguments: [
              {
                kind: 'Argument',
...
>;
export const GetTimelineThreadsFromCompanyIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
>;
export const GetTimelineThreadsFromOpportunityIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
        ...
        selections: [
          {
            ...
            name: {
              kind: 'Name',
              value: 'getTimelineThreadsFromOpportunityId',
            },
            arguments: [
              {
                kind: 'Argument',
  ...
  GetTimelineThreadsFromOpportunityIdQuery,
  GetTimelineThreadsFromOpportunityIdQueryVariables
>;
export const GetTimelineThreadsFromPersonIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetTimelineThreadsFromPersonId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
