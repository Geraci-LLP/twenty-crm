export enum SidePanelPages {
  ...
  DashboardFieldsSettings = 'dashboard-fields-settings',
  DashboardFieldSettings = 'dashboard-field-settings',
  DashboardRecordTableSettings = 'dashboard-record-table-settings',
  RecordPageChartSettings = 'record-page-chart-settings',
  RecordPageIframeSettings = 'record-page-iframe-settings',
  RecordPageFieldsSettings = 'record-page-fields-settings',
  RecordPageFieldSettings = 'record-page-field-settings',
  RecordPageRecordTableSettings = 'record-page-record-table-settings',
